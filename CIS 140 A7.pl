...
my $lastName;
	...
	while ($lastName !~ /^[a-zA-Z]{2,20}$/x) {
		print "What is the last name of the patient? ";
...
my $firstName;
	...
	while ($firstName !~ /^[a-zA-Z]{2,20}$/x) {
		print "What is the first name of the patient? ";
...
sub setMiddleName {
	...
	while ($middleName !~ /^[a-zA-Z]{2,20}$/x) {
		print "What is the middle name of the patient? ";
...
sub setBirthDay {
	...
	while ($birthDay < 1 || $birthDay > 31) {
		print "What day was the patient born? ";
...
sub setAilment {
	...
	while ($ailment !~ /^[a-zA-Z]{2,20}$/x) {
		print "What is the patients suffering from? ";
		chomp ($ailment = <STDIN>);
